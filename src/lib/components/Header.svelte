...
<header
	class="fixed top-0 left-0 right-0 z-50 w-full bg-slate-900/80 backdrop-blur-sm border-b border-slate-800/60 flex items-center px-4 justify-between transition-all duration-150 select-none {compact
		? 'h-8 text-xs'
		: 'h-12 text-sm'}"
>
	<div class="flex items-center gap-3 sm:gap-4 min-w-0">
		...
		<span
			class="hidden md:inline font-bold text-white tracking-wider select-none shrink-0 {compact
