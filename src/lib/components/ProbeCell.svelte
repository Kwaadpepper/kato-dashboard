  ...
  >
    ...
    <div class="flex items-center justify-between gap-1.5 pt-1">
      ...
      <div class="kato-pill">
        ...
        <span class="kato-pill-value text-xs sm:text-sm"
          >{responseTimeDisplay}</span
        >
      </div>
    </div>
  </div>
{:else if density === "medium"}
  ...
  >
    ...
    <div class="flex items-center justify-end min-w-0">
      <span
        class="w-2.5 h-2.5 rounded-full shrink-0 {color.bgClass} shadow-xs"
        aria-hidden="true"
      ></span>
    </div>
    ...
    <div class="flex items-center justify-between gap-1.5 w-full pt-1">
      <div class="kato-pill text-[11px] py-0.5 px-1.5">
        ...
        <span class="kato-pill-value text-[11px] sm:text-xs"
          >{uptimeDisplay}</span
        >
      </div>
      <div class="kato-pill text-[11px] py-0.5 px-1.5">
...
{:else}
  ...
  <div
    ...
    tabindex={tabIndex}
    role="button"
    aria-label="{probe.name} : {statusLabel}, {t(
      'probe.latency',
    ).toLowerCase()} {responseTimeDisplay}"
    onclick={handleClick}
    onkeydown={handleKeydown}
    onfocus={oncellfocus}
  >
    ...
    <div class="flex items-center justify-end w-full">
      <span
        class="w-2 h-2 rounded-full shrink-0 {color.bgClass} shadow-xs"
        aria-hidden="true"
      ></span>
    </div>
    ...
    <div
      class="my-auto py-0.5 flex items-center justify-center text-center px-0.5"
    >
      <h2
    ...
    <div class="flex items-center justify-center w-full">
      <span
        class="text-[10px] sm:text-[11px] font-mono text-[var(--kato-text-secondary)]"
      >
        {responseTimeDisplay}
      </span>
    </div>
